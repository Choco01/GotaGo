...
open class SlideMenuController: UIViewController, UIGestureRecognizerDelegate {
    ...
    open func initView() {
        ...
        mainContainerView.backgroundColor = UIColor.black//UIColor.clearColor()
      ...
      var opacityframe: CGRect = view.bounds
        ...
        opacityView.backgroundColor = UIColor.black//SlideMenuOptions.opacityViewBackgroundColor
      ...
      if leftViewController != nil {
        ...
        leftContainerView.backgroundColor = UIColor.black//UIColor.clearColor()
